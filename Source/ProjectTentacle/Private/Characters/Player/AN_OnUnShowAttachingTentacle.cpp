...
#include "Characters/Player/AN_OnUnShowAttachingTentacle.h"

#include "Characters/Base/CharacterActionInterface.h"

void UAN_OnUnShowAttachingTentacle::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
	...
	if(OwnerRef->GetClass()->ImplementsInterface(UCharacterActionInterface::StaticClass()))
	{
		...
		ICharacterActionInterface::Execute_OnMakingTentacleVisible(OwnerRef, false);
	}
}
