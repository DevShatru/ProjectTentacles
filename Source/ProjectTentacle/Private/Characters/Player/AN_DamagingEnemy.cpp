...
#include "Characters/Player/AN_DamagingEnemy.h"

#include "Characters/Base/CharacterActionInterface.h"

void UAN_DamagingEnemy::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
	...
	if(OwnerRef->GetClass()->ImplementsInterface(UCharacterActionInterface::StaticClass()))
	{
		...
		ICharacterActionInterface::Execute_DamagingTarget(OwnerRef);
	}
