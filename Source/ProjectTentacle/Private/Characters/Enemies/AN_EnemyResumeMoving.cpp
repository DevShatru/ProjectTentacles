...
#include "Characters/Enemies/AN_EnemyResumeMoving.h"

#include "Characters/Base/CharacterActionInterface.h"

void UAN_EnemyResumeMoving::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
	...
	if(OwnerRef->GetClass()->ImplementsInterface(UCharacterActionInterface::StaticClass()))
	{
		...
		ICharacterActionInterface::Execute_OnResumeMovement(OwnerRef);
	}
