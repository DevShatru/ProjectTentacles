...
#include "Characters/Enemies/AN_EnemyRange_FinishFire.h"

#include "Characters/Base/EnemyRangeInterface.h"

void UAN_EnemyRange_FinishFire::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
	...
	if(OwnerRef->GetClass()->ImplementsInterface(UEnemyRangeInterface::StaticClass()))
	{
		...
		IEnemyRangeInterface::Execute_OnRifleFinishFiring(OwnerRef);
	}
