...
#include "Characters/Enemies/AN_EnemyRange_BeginAim.h"

#include "Characters/Base/EnemyRangeInterface.h"

void UAN_EnemyRange_BeginAim::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
	...
	if(OwnerRef->GetClass()->ImplementsInterface(UEnemyRangeInterface::StaticClass()))
	{
		...
		IEnemyRangeInterface::Execute_OnRifleBeginAiming(OwnerRef);
	}
}
