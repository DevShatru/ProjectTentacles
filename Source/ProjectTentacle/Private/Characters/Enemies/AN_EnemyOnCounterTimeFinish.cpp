...
#include "Characters/Enemies/AN_EnemyOnCounterTimeFinish.h"

#include "Characters/Base/CharacterActionInterface.h"

void UAN_EnemyOnCounterTimeFinish::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
	...
	if(OwnerRef->GetClass()->ImplementsInterface(UCharacterActionInterface::StaticClass()))
	{
		...
		ICharacterActionInterface::Execute_OnCounterTimeEnd(OwnerRef);
	}
