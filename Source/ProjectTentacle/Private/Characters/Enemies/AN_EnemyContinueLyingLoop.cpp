...
#include "Characters/Enemies/AN_EnemyContinueLyingLoop.h"

#include "Characters/Base/CharacterActionInterface.h"

void UAN_EnemyContinueLyingLoop::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
	...
	if(OwnerRef->GetClass()->ImplementsInterface(UCharacterActionInterface::StaticClass()))
	{
		...
		ICharacterActionInterface::Execute_RepeatLyingOnTheGround(OwnerRef);
	}
