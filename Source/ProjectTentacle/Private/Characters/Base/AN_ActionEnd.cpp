...
#include "Characters/Base/AN_ActionEnd.h"

#include "Characters/Base/CharacterActionInterface.h"

void UAN_ActionEnd::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
	...
	if(OwnerRef->GetClass()->ImplementsInterface(UCharacterActionInterface::StaticClass()))
	{
		...
		ICharacterActionInterface::Execute_ActionEnd(OwnerRef, false);
	}
}
