...
#include "Characters/Base/AN_WaitForComboCommand.h"
#include "Characters/Base/CharacterActionInterface.h"

void UAN_WaitForComboCommand::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
	...
	if(OwnerRef->GetClass()->ImplementsInterface(UCharacterActionInterface::StaticClass()))
	{
		...
		ICharacterActionInterface::Execute_StartWaitForCombo(OwnerRef);
	}
