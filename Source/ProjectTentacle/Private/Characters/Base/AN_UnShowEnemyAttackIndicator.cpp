...
#include "Characters/Base/AN_UnShowEnemyAttackIndicator.h"

#include "Characters/Base/EnemyWidgetInterface.h"

void UAN_UnShowEnemyAttackIndicator::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
	...
	if(OwnerRef->GetClass()->ImplementsInterface(UEnemyWidgetInterface::StaticClass()))
	{
		...
		IEnemyWidgetInterface::Execute_UnShowEnemyAttackIndicator(OwnerRef);
	}	
